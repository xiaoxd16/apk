...
.method public buildForScope(Ljava/lang/Object;)Lde/greenrobot/event/util/AsyncExecutor;
    ...
    .prologue
    .line 66
    iget-object v0, p0, Lde/greenrobot/event/util/AsyncExecutor$Builder;->c:Lde/greenrobot/event/EventBus;
    ...
    iput-object v0, p0, Lde/greenrobot/event/util/AsyncExecutor$Builder;->c:Lde/greenrobot/event/EventBus;

    .line 69
    :cond_0
    iget-object v0, p0, Lde/greenrobot/event/util/AsyncExecutor$Builder;->a:Ljava/util/concurrent/Executor;
    ...
    iput-object v0, p0, Lde/greenrobot/event/util/AsyncExecutor$Builder;->a:Ljava/util/concurrent/Executor;

    .line 72
    :cond_1
    iget-object v0, p0, Lde/greenrobot/event/util/AsyncExecutor$Builder;->b:Ljava/lang/Class;
    ...
    iput-object v0, p0, Lde/greenrobot/event/util/AsyncExecutor$Builder;->b:Ljava/lang/Class;

    .line 75
    :cond_2
    new-instance v0, Lde/greenrobot/event/util/AsyncExecutor;

    iget-object v1, p0, Lde/greenrobot/event/util/AsyncExecutor$Builder;->a:Ljava/util/concurrent/Executor;

    iget-object v2, p0, Lde/greenrobot/event/util/AsyncExecutor$Builder;->c:Lde/greenrobot/event/EventBus;

    iget-object v3, p0, Lde/greenrobot/event/util/AsyncExecutor$Builder;->b:Ljava/lang/Class;
...
.method public eventBus(Lde/greenrobot/event/EventBus;)Lde/greenrobot/event/util/AsyncExecutor$Builder;
    ...
    .prologue
    .line 53
    iput-object p1, p0, Lde/greenrobot/event/util/AsyncExecutor$Builder;->c:Lde/greenrobot/event/EventBus;
...
.method public failureEventType(Ljava/lang/Class;)Lde/greenrobot/event/util/AsyncExecutor$Builder;
    ...
    .prologue
    .line 48
    iput-object p1, p0, Lde/greenrobot/event/util/AsyncExecutor$Builder;->b:Ljava/lang/Class;
...
.method public threadPool(Ljava/util/concurrent/Executor;)Lde/greenrobot/event/util/AsyncExecutor$Builder;
    ...
    .prologue
    .line 43
    iput-object p1, p0, Lde/greenrobot/event/util/AsyncExecutor$Builder;->a:Ljava/util/concurrent/Executor;
