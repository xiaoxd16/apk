...
.field private k:Lokhttp3/internal/ws/WebSocketReader;

.field private l:Lokhttp3/internal/ws/a;
...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput-boolean v0, Lokhttp3/internal/ws/RealWebSocket;->d:Z
    ...
    sput-object v0, Lokhttp3/internal/ws/RealWebSocket;->e:Ljava/util/List;
...
.method public constructor <init>(Lokhttp3/Request;Lokhttp3/WebSocketListener;Ljava/util/Random;)V
    ...
    iput-object v0, p0, Lokhttp3/internal/ws/RealWebSocket;->p:Ljava/util/ArrayDeque;

    .line 118
    const/4 v0, -0x1

    iput v0, p0, Lokhttp3/internal/ws/RealWebSocket;->t:I
    ...
    .line 136
    :cond_0
    iput-object p1, p0, Lokhttp3/internal/ws/RealWebSocket;->f:Lokhttp3/Request;

    .line 137
    iput-object p2, p0, Lokhttp3/internal/ws/RealWebSocket;->a:Lokhttp3/WebSocketListener;

    .line 138
    iput-object p3, p0, Lokhttp3/internal/ws/RealWebSocket;->g:Ljava/util/Random;
    ...
    iput-object v0, p0, Lokhttp3/internal/ws/RealWebSocket;->h:Ljava/lang/String;
    ...
    iput-object v0, p0, Lokhttp3/internal/ws/RealWebSocket;->j:Ljava/lang/Runnable;
...
.method private declared-synchronized a(Lokio/ByteString;I)Z
    ...
    iget-boolean v1, p0, Lokhttp3/internal/ws/RealWebSocket;->r:Z
    :try_end_0
...
.method private c()V
    ...
    .prologue
    .line 420
    sget-boolean v0, Lokhttp3/internal/ws/RealWebSocket;->d:Z
    ...
    .line 422
    :cond_0
    iget-object v0, p0, Lokhttp3/internal/ws/RealWebSocket;->m:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    iget-object v1, p0, Lokhttp3/internal/ws/RealWebSocket;->j:Ljava/lang/Runnable;
...
.method a(Lokhttp3/Response;)V
    ...
    iget-object v2, p0, Lokhttp3/internal/ws/RealWebSocket;->h:Ljava/lang/String;
...
.method a()Z
    ...
    .line 449
    :try_start_0
    iget-boolean v2, p0, Lokhttp3/internal/ws/RealWebSocket;->v:Z
    ...
    .line 453
    :cond_0
    iget-object v9, p0, Lokhttp3/internal/ws/RealWebSocket;->l:Lokhttp3/internal/ws/a;
    ...
    .line 457
    instance-of v6, v4, Lokhttp3/internal/ws/RealWebSocket$b;

    if-eqz v6, :cond_3

    .line 458
    iget v7, p0, Lokhttp3/internal/ws/RealWebSocket;->t:I

    .line 459
    iget-object v6, p0, Lokhttp3/internal/ws/RealWebSocket;->u:Ljava/lang/String;

    .line 460
    if-eq v7, v8, :cond_2

    .line 461
    iget-object v3, p0, Lokhttp3/internal/ws/RealWebSocket;->n:Lokhttp3/internal/ws/RealWebSocket$Streams;
    ...
    .line 463
    iget-object v5, p0, Lokhttp3/internal/ws/RealWebSocket;->m:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    .line 477
    :try_start_1
    invoke-virtual {v9, v2}, Lokhttp3/internal/ws/a;->b(Lokio/ByteString;)V
    :try_end_1
    ...
    :cond_2
    :try_start_2
    iget-object v8, p0, Lokhttp3/internal/ws/RealWebSocket;->m:Ljava/util/concurrent/ScheduledExecutorService;

    new-instance v10, Lokhttp3/internal/ws/RealWebSocket$a;

    invoke-direct {v10, p0}, Lokhttp3/internal/ws/RealWebSocket$a;-><init>(Lokhttp3/internal/ws/RealWebSocket;)V

    move-object v0, v4

    check-cast v0, Lokhttp3/internal/ws/RealWebSocket$b;

    move-object v3, v0

    iget-wide v12, v3, Lokhttp3/internal/ws/RealWebSocket$b;->c:J
    ...
    iput-object v3, p0, Lokhttp3/internal/ws/RealWebSocket;->s:Ljava/util/concurrent/ScheduledFuture;
    ...
    :cond_4
    :try_start_3
    instance-of v2, v3, Lokhttp3/internal/ws/RealWebSocket$c;
    ...
    check-cast v0, Lokhttp3/internal/ws/RealWebSocket$c;
    ...
    .line 481
    check-cast v3, Lokhttp3/internal/ws/RealWebSocket$c;

    iget v3, v3, Lokhttp3/internal/ws/RealWebSocket$c;->a:I
    ...
    .line 481
    invoke-virtual {v9, v3, v6, v7}, Lokhttp3/internal/ws/a;->a(IJ)Lokio/Sink;
    ...
    :cond_5
    :try_start_6
    instance-of v2, v3, Lokhttp3/internal/ws/RealWebSocket$b;

    if-eqz v2, :cond_6

    .line 490
    check-cast v3, Lokhttp3/internal/ws/RealWebSocket$b;

    .line 491
    iget v2, v3, Lokhttp3/internal/ws/RealWebSocket$b;->a:I

    iget-object v3, v3, Lokhttp3/internal/ws/RealWebSocket$b;->b:Lokio/ByteString;

    invoke-virtual {v9, v2, v3}, Lokhttp3/internal/ws/a;->a(ILokio/ByteString;)V

    .line 494
    if-eqz v4, :cond_1

    .line 495
    iget-object v2, p0, Lokhttp3/internal/ws/RealWebSocket;->a:Lokhttp3/WebSocketListener;
...
.method declared-synchronized a(ILjava/lang/String;J)Z
    ...
    iget-boolean v2, p0, Lokhttp3/internal/ws/RealWebSocket;->r:Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    new-instance v3, Lokhttp3/internal/ws/RealWebSocket$b;

    invoke-direct {v3, p1, v1, p3, p4}, Lokhttp3/internal/ws/RealWebSocket$b;-><init>(ILokio/ByteString;J)V
...
.method b()V
    ...
    .line 521
    :cond_0
    iget-object v0, p0, Lokhttp3/internal/ws/RealWebSocket;->l:Lokhttp3/internal/ws/a;
...
.method public connect(Lokhttp3/OkHttpClient;)V
    ...
    sget-object v1, Lokhttp3/internal/ws/RealWebSocket;->e:Ljava/util/List;
    ...
    .line 173
    iget-object v2, p0, Lokhttp3/internal/ws/RealWebSocket;->f:Lokhttp3/Request;
    ...
    iget-object v4, p0, Lokhttp3/internal/ws/RealWebSocket;->h:Ljava/lang/String;
    ...
    iput-object v0, p0, Lokhttp3/internal/ws/RealWebSocket;->i:Lokhttp3/Call;
...
.method public failWebSocket(Ljava/lang/Exception;Lokhttp3/Response;)V
    ...
    .line 536
    iget-object v1, p0, Lokhttp3/internal/ws/RealWebSocket;->n:Lokhttp3/internal/ws/RealWebSocket$Streams;

    .line 537
    const/4 v0, 0x0

    iput-object v0, p0, Lokhttp3/internal/ws/RealWebSocket;->n:Lokhttp3/internal/ws/RealWebSocket$Streams;

    .line 538
    iget-object v0, p0, Lokhttp3/internal/ws/RealWebSocket;->s:Ljava/util/concurrent/ScheduledFuture;
...
.method public initReaderAndWriter(Ljava/lang/String;JLokhttp3/internal/ws/RealWebSocket$Streams;)V
    ...
    .line 243
    :try_start_0
    iput-object p4, p0, Lokhttp3/internal/ws/RealWebSocket;->n:Lokhttp3/internal/ws/RealWebSocket$Streams;
    ...
    iget-object v3, p0, Lokhttp3/internal/ws/RealWebSocket;->g:Ljava/util/Random;

    invoke-direct {v0, v1, v2, v3}, Lokhttp3/internal/ws/a;-><init>(ZLokio/BufferedSink;Ljava/util/Random;)V

    iput-object v0, p0, Lokhttp3/internal/ws/RealWebSocket;->l:Lokhttp3/internal/ws/a;
    ...
    iput-object v0, p0, Lokhttp3/internal/ws/RealWebSocket;->m:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    iput-object v0, p0, Lokhttp3/internal/ws/RealWebSocket;->k:Lokhttp3/internal/ws/WebSocketReader;
...
.method public onReadClose(ILjava/lang/String;)V
    ...
    .line 339
    iget-object v1, p0, Lokhttp3/internal/ws/RealWebSocket;->s:Ljava/util/concurrent/ScheduledFuture;
    ...
    .line 340
    :cond_2
    iget-object v1, p0, Lokhttp3/internal/ws/RealWebSocket;->m:Ljava/util/concurrent/ScheduledExecutorService;
...
.method public declared-synchronized onReadPing(Lokio/ByteString;)V
    ...
    .line 320
    iget v0, p0, Lokhttp3/internal/ws/RealWebSocket;->b:I

    add-int/lit8 v0, v0, 0x1

    iput v0, p0, Lokhttp3/internal/ws/RealWebSocket;->b:I
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public declared-synchronized onReadPong(Lokio/ByteString;)V
    ...
    :try_start_0
    iget v0, p0, Lokhttp3/internal/ws/RealWebSocket;->c:I

    add-int/lit8 v0, v0, 0x1

    iput v0, p0, Lokhttp3/internal/ws/RealWebSocket;->c:I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public request()Lokhttp3/Request;
    ...
    .prologue
    .line 157
    iget-object v0, p0, Lokhttp3/internal/ws/RealWebSocket;->f:Lokhttp3/Request;
...
.method public send(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v0, v1}, Lokhttp3/internal/ws/RealWebSocket;->a(Lokio/ByteString;I)Z
