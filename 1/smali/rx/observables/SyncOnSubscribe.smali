...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lrx/observables/SyncOnSubscribe$a;,
        Lrx/observables/SyncOnSubscribe$b;
    }
.end annotation
...
.method public static createSingleState(Lrx/functions/Func0;Lrx/functions/Action2;)Lrx/observables/SyncOnSubscribe;
    ...
    .line 134
    new-instance v1, Lrx/observables/SyncOnSubscribe$b;

    invoke-direct {v1, p0, v0}, Lrx/observables/SyncOnSubscribe$b;-><init>(Lrx/functions/Func0;Lrx/functions/Func2;)V
...
.method public static createSingleState(Lrx/functions/Func0;Lrx/functions/Action2;Lrx/functions/Action1;)Lrx/observables/SyncOnSubscribe;
    ...
    invoke-direct {v1, p0, v0, p2}, Lrx/observables/SyncOnSubscribe$b;-><init>(Lrx/functions/Func0;Lrx/functions/Func2;Lrx/functions/Action1;)V
...
.method public static createStateful(Lrx/functions/Func0;Lrx/functions/Func2;)Lrx/observables/SyncOnSubscribe;
    ...
    invoke-direct {v0, p0, p1}, Lrx/observables/SyncOnSubscribe$b;-><init>(Lrx/functions/Func0;Lrx/functions/Func2;)V
...
.method public static createStateful(Lrx/functions/Func0;Lrx/functions/Func2;Lrx/functions/Action1;)Lrx/observables/SyncOnSubscribe;
    ...
    invoke-direct {v0, p0, p1, p2}, Lrx/observables/SyncOnSubscribe$b;-><init>(Lrx/functions/Func0;Lrx/functions/Func2;Lrx/functions/Action1;)V
...
.method public static createStateless(Lrx/functions/Action1;)Lrx/observables/SyncOnSubscribe;
    ...
    invoke-direct {v1, v0}, Lrx/observables/SyncOnSubscribe$b;-><init>(Lrx/functions/Func2;)V
...
.method public static createStateless(Lrx/functions/Action1;Lrx/functions/Action0;)Lrx/observables/SyncOnSubscribe;
    ...
    .line 269
    new-instance v2, Lrx/observables/SyncOnSubscribe$b;

    invoke-direct {v2, v0, v1}, Lrx/observables/SyncOnSubscribe$b;-><init>(Lrx/functions/Func2;Lrx/functions/Action1;)V
...
.method public final call(Lrx/Subscriber;)V
    ...
    .line 60
    new-instance v1, Lrx/observables/SyncOnSubscribe$a;

    invoke-direct {v1, p1, p0, v0}, Lrx/observables/SyncOnSubscribe$a;-><init>(Lrx/Subscriber;Lrx/observables/SyncOnSubscribe;Ljava/lang/Object;)V
