...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lrx/internal/schedulers/GenericScheduledExecutorService;->a:[Ljava/util/concurrent/ScheduledExecutorService;
    ...
    sput-object v0, Lrx/internal/schedulers/GenericScheduledExecutorService;->b:Ljava/util/concurrent/ScheduledExecutorService;

    .line 39
    sget-object v0, Lrx/internal/schedulers/GenericScheduledExecutorService;->b:Ljava/util/concurrent/ScheduledExecutorService;
...
.method private constructor <init>()V
    ...
    sget-object v1, Lrx/internal/schedulers/GenericScheduledExecutorService;->a:[Ljava/util/concurrent/ScheduledExecutorService;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicReference;-><init>(Ljava/lang/Object;)V

    iput-object v0, p0, Lrx/internal/schedulers/GenericScheduledExecutorService;->c:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public static getInstance()Ljava/util/concurrent/ScheduledExecutorService;
    ...
    iget-object v0, v0, Lrx/internal/schedulers/GenericScheduledExecutorService;->c:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public shutdown()V
    ...
    .line 91
    :cond_0
    iget-object v0, p0, Lrx/internal/schedulers/GenericScheduledExecutorService;->c:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 95
    :cond_2
    iget-object v1, p0, Lrx/internal/schedulers/GenericScheduledExecutorService;->c:Ljava/util/concurrent/atomic/AtomicReference;

    sget-object v2, Lrx/internal/schedulers/GenericScheduledExecutorService;->a:[Ljava/util/concurrent/ScheduledExecutorService;
...
.method public start()V
    ...
    .line 71
    invoke-static {}, Lrx/internal/schedulers/a;->b()Ljava/util/concurrent/ScheduledExecutorService;
