...
.field private final d:Lrx/functions/FuncN;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lrx/functions/FuncN",
            "<+TR;>;"
...
.method static constructor <clinit>()V
    ...
    sput v0, Lrx/internal/operators/OperatorZip$a;->b:I
...
.method public constructor <init>(Lrx/Subscriber;Lrx/functions/FuncN;)V
    ...
    iput-object v0, p0, Lrx/internal/operators/OperatorZip$a;->e:Lrx/subscriptions/CompositeSubscription;

    .line 184
    iput-object p1, p0, Lrx/internal/operators/OperatorZip$a;->a:Lrx/Observer;

    .line 185
    iput-object p2, p0, Lrx/internal/operators/OperatorZip$a;->d:Lrx/functions/FuncN;

    .line 186
    iget-object v0, p0, Lrx/internal/operators/OperatorZip$a;->e:Lrx/subscriptions/CompositeSubscription;
...
.method a()V
    ...
    .line 220
    :cond_1
    invoke-virtual {p0}, Lrx/internal/operators/OperatorZip$a;->getAndIncrement()J
    ...
    .line 222
    iget-object v6, p0, Lrx/internal/operators/OperatorZip$a;->a:Lrx/Observer;
    ...
    .line 252
    :try_start_0
    iget-object v0, p0, Lrx/internal/operators/OperatorZip$a;->d:Lrx/functions/FuncN;
    ...
    .line 255
    iget v0, p0, Lrx/internal/operators/OperatorZip$a;->c:I

    add-int/lit8 v0, v0, 0x1

    iput v0, p0, Lrx/internal/operators/OperatorZip$a;->c:I
    :try_end_0
    ...
    sget v2, Lrx/internal/operators/OperatorZip$a;->b:I
    ...
    iget v8, p0, Lrx/internal/operators/OperatorZip$a;->c:I
    ...
    .line 277
    :cond_8
    iput v1, p0, Lrx/internal/operators/OperatorZip$a;->c:I

    goto/16 :goto_1

    .line 283
    :cond_9
    invoke-virtual {p0}, Lrx/internal/operators/OperatorZip$a;->decrementAndGet()J
...
.method public a([Lrx/Observable;Ljava/util/concurrent/atomic/AtomicLong;)V
    ...
    invoke-direct {v3, p0}, Lrx/internal/operators/OperatorZip$a$a;-><init>(Lrx/internal/operators/OperatorZip$a;)V

    .line 194
    aput-object v3, v2, v0

    .line 195
    iget-object v4, p0, Lrx/internal/operators/OperatorZip$a;->e:Lrx/subscriptions/CompositeSubscription;
    ...
    .line 198
    :cond_0
    iput-object p2, p0, Lrx/internal/operators/OperatorZip$a;->g:Ljava/util/concurrent/atomic/AtomicLong;

    .line 199
    iput-object v2, p0, Lrx/internal/operators/OperatorZip$a;->f:[Ljava/lang/Object;
